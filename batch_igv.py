...
def main():
    ...
    outputFile = open(args.batchFile + '.txt', 'w')
    ...
    if args.runScript:
        run_in_terminal(args.batchFile, args.pathToIGV)
...
def print_specs(args, outputFile):
    ...
    and specifies the Snapshot Directory where phots will be saved.
    """
...
def run_in_terminal(outputFile, pathToIGV):
    ...
    os.system(pathToIGV + ' -b ' + pathToBatch + ".txt")
...
#Parameter examples: python batch_igv.py Y:\data\igv_sessions\AndreySession.xml 400 FilesUsedBatch Y:\data\SnapShots C:\Users\ank22\Documents\hg002_deepvar_manual_currate.csv C:\IGV_2.5.0\igv.bat --runScript
